...
export const skillCategories: SkillCategory[] = [
  {
    ...
    skills: [
      ...
      { name: "Next.js",     level: 4, logo: `${DI}/nextjs/nextjs-original.svg`,           color: "#000000" },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "Express.js",  level: 4, logo: `${DI}/express/express-original.svg`,       color: "#000000" },
      ...
      { name: "FastAPI",     level: 2, logo: "https://fastapi.tiangolo.com/img/logo-margin/logo-teal.png", color: "#009688" },
      { name: "Socket.IO",   level: 3, logo: "https://cdn.worldvectorlogo.com/logos/socket-io.svg",       color: "#000000" },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "OpenAI API",   level: 3, logo: "https://cdn.worldvectorlogo.com/logos/openai-2.svg",          color: "#000000" },
      ...
      { name: "Notion",       level: 4, logo: "https://cdn.worldvectorlogo.com/logos/notion-2.svg", color: "#000000" },
      { name: "Photoshop",    level: 2, logo: `${DI}/photoshop/photoshop-plain.svg`, color: "#31A8FF" },
    ],
  },
];

/** 1=Beginner 2=Elementary 3=Intermediate 4=Advanced (max) */
