            ...
            <div className="flex gap-2">
              {SOCIALS.map(({ href, label, path }) => (
                <a
                  ...
                  aria-label={label}
                  className="w-8 h-8 rounded-lg border border-neutral-200 bg-white flex items-center justify-center text-neutral-400 hover:text-[#0a0a0a] hover:border-neutral-400 transition-colors"
                >
